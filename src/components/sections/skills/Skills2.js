...
const Skills2 = () => {
	...
	return (
		<section
			id="skills"
			className=" pb-20 md:pb-100px xl:pb-30 relative after:absolute after:top-1/2 after:-translate-y-1/2 after:right-5 after:w-650px after:h-550px after:blur-[150px] after:rounded-50% after:bg-gradient-circle-2 after:-z-1  after:translate-x-1/2 after:opacity-60 "
		>
			<div className="">
				<div className="container">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-306px sm:max-w-full w-full mx-auto">
						{/* <!-- skill 1 --> */}
						<div
							className="rounded-25px relative overflow-hidden pt-30px pb-35px lg:pt-35px lg:pb-10 2xl:pt-45px 2xl:pb-50px px-15px 2xl:pl-35px 2xl:pr-30px  bg-cream-light-color dark:bg-bg-color-6 backdrop-blur-[40px]  group transition-all duration-500   wow fadeInUp"
							data-wow-delay="0.3s"
						>
							<div className="mb-15px  flex items-center gap-18px sm:gap-15px md:gap-18px lg:gap-15px xl:gap-18px  ">
								<div className="bg-dark-color dark:bg-transparent flex-shrink-0 w-60px h-60px sm:w-46px sm:h-46px md:w-20 md:h-20 lg:w-46px lg:h-46px xl:w-20 xl:h-20 inline-flex justify-center items-center leading-1 rounded-lg">
									<img
